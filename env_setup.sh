...
export HF_HOME=${CIFAR100_HF_HOME:-$CIFAR100_SCRATCH_BASE/cache/huggingface}
export HF_HUB_CACHE=${CIFAR100_HF_HUB_CACHE:-$HF_HOME/hub}
export HF_DATASETS_CACHE=${CIFAR100_HF_DATASETS_CACHE:-$HF_HOME/datasets}
export TRANSFORMERS_CACHE=${CIFAR100_TRANSFORMERS_CACHE:-$HF_HOME/transformers}
